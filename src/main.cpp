...
void autonomous()
{
	...
	// curve_drive_to_point(0_in, 36_in, 100, 30, 0.024, -0.00416, 200, 0.01, 0.008, 200, 0, false, false, false, NONE, 5, 0.00001, 2, 28);
	// gyro_drive(36_in, 50);
	gyro_turn_to(180_deg, 40, 10.0, 0.003, 0.0, 0.0, 2);
	pros::delay(1000);
	gyro_turn_to(0_deg, 40, 10.0, 0.003, 0.0, 0.0, 2);
	// pros::delay(1000);
	// curve_drive_to_point(0_in, 0_in, 100, 30, 0.024, -0.00416, 200, 0.01, 0.008, 200, 0, false, false, true, NONE, 5, 0.00001, 2, 28);
	// gyro_drive(-36_in, 50);
	// gyro_turn_to(0_deg, 40, 10.0, 0.003, 0.0, 0.0, 2);
