...
pros::vision_signature_s_t dummy_1;
pros::vision_signature_s_t dummy_2;
pros::vision_signature_s_t dummy_3;
pros::vision_signature_s_t dummy_4;
int red_area = 0;
int red_center = 0;
int red_bottom = 0;
int blue_area = 0;
...
//     pros::lcd::print(3,"blue centre %d  blue bottom %d", blue_center, blue_bottom);
//     ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//
//
...
//     pros::lcd::print(1,"red centre %d  red bottom %d", red_center, red_bottom);
//     ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//
//
...
// //
// // //UPSTAIRS_SCHOOL
// // // vision::signature RED_GOAL (1, 8013, 10209, 9111, -1967, -643, -1305, 3.000, 0);
// // // vision::signature YELLOW_GOAL (2, 1119, 2551, 1835, -4741, -3399, -4070, 2.900, 0);
// // // vision::signature BLUE_GOAL (3, -4191, -2397, -3294, 9075, 15579, 12327, 3.000, 0);
// // // vision::signature SIG_4 (4, 0, 0, 0, 0, 0, 0, 2.500, 0);
// // // vision::signature SIG_5 (5, 0, 0, 0, 0, 0, 0, 2.500, 0);
// // // vision::signature SIG_6 (6, 0, 0, 0, 0, 0, 0, 2.500, 0);
// // // vision::signature SIG_7 (7, 0, 0, 0, 0, 0, 0, 2.500, 0);
// // // vex::vision vision1 ( vex::PORT1, 150, RED_GOAL, YELLOW_GOAL, BLUE_GOAL, SIG_4, SIG_5, SIG_6, SIG_7 );
// //
// // //SECOND_UPSTAIRS_CODES
// // // vision::signature RED_GOAL (1, 8403, 9637, 9020, -1675, -885, -1280, 3.000, 0);
// // // vision::signature YELLOW_GOAL (2, 1309, 1745, 1528, -4211, -3653, -3932, 3.000, 0);
// // // vision::signature BLUE_GOAL (3, -3325, -2107, -2716, 10427, 14233, 12330, 3.000, 0);
// // // vision::signature SIG_4 (4, 0, 0, 0, 0, 0, 0, 2.500, 0);
// // // vision::signature SIG_5 (5, 0, 0, 0, 0, 0, 0, 2.500, 0);
// // // vision::signature SIG_6 (6, 0, 0, 0, 0, 0, 0, 2.500, 0);
// // // vision::signature SIG_7 (7, 0, 0, 0, 0, 0, 0, 2.500, 0);
// // // vex::vision vision1 ( vex::PORT1, 20, RED_GOAL, YELLOW_GOAL, BLUE_GOAL, SIG_4, SIG_5, SIG_6, SIG_7 );
// //
// // //THIRD_UPSTAIRS
// // // vision::signature RED_GOAL (1, 7763, 10029, 8896, -1821, -817, -1319, 1.800, 0);
// // // vision::signature YELLOW_GOAL (2, 995, 1635, 1314, -4337, -3615, -3976, 3.000, 0);
// // // vision::signature BLUE_GOAL (3, -3013, -2047, -2530, 9925, 14135, 12030, 3.000, 0);
// // // vision::signature SIG_4 (4, 0, 0, 0, 0, 0, 0, 2.500, 0);
// // // vision::signature SIG_5 (5, 0, 0, 0, 0, 0, 0, 2.500, 0);
// // // vision::signature SIG_6 (6, 0, 0, 0, 0, 0, 0, 2.500, 0);
// // // vision::signature SIG_7 (7, 0, 0, 0, 0, 0, 0, 2.500, 0);
...
// //
// // //FOURTH_UPSTAIRS
// // // vision::signature SIG_1 (1, 1007, 1689, 1348, -4289, -3641, -3965, 3.000, 0);
// // // vision::signature SIG_2 (2, 7505, 10337, 8921, -2033, -885, -1459, 3.000, 0);
// // // vision::signature SIG_3 (3, -3099, -1809, -2454, 9627, 14229, 11928, 3.000, 0);
// // // vision::signature SIG_4 (4, 0, 0, 0, 0, 0, 0, 3.000, 0);
// // // vision::signature SIG_5 (5, 0, 0, 0, 0, 0, 0, 3.000, 0);
// // // vision::signature SIG_6 (6, 0, 0, 0, 0, 0, 0, 3.000, 0);
// // // vision::signature SIG_7 (7, 0, 0, 0, 0, 0, 0, 3.000, 0);
...
//   blue_1 = vision_sensor.signature_from_utility(3, -3099, -1809, -2454, 9627, 14229, 11928, 3.000, 0);
//   yellow_1 = vision_sensor.signature_from_utility(2, 1007, 1689, 1348, -4289, -3641, -3965, 3.000, 0);
//   red_1 = vision_sensor.signature_from_utility(1, 7505, 10337, 8921, -2033, -885, -1459, 3.000, 0);
//   dummy_1 = vision_sensor.signature_from_utility(4, 0, 0, 0, 0, 0, 0, 3.000, 0);
//   dummy_2 = vision_sensor.signature_from_utility(5, 0, 0, 0, 0, 0, 0, 3.000, 0);
//   dummy_3 = vision_sensor.signature_from_utility(6, 0, 0, 0, 0, 0, 0, 3.000, 0);
//   dummy_4 = vision_sensor.signature_from_utility(7, 0, 0, 0, 0, 0, 0, 3.000, 0);
//   vision_sensor.set_signature(1, &blue_1);
//   vision_sensor.set_signature(2, &yellow_1);
//   vision_sensor.set_signature(3, &red_1);
//   vision_sensor.set_signature(4, &dummy_1);
//   vision_sensor.set_signature(5, &dummy_2);
//   vision_sensor.set_signature(6, &dummy_3);
//   vision_sensor.set_signature(7, &dummy_4);
//
